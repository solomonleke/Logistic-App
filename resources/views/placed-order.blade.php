           ...
           <div class="row feature-content">
              <div class="col-xl-5 offset-xl-7 col-lg-6 offset-lg-6 pr-0">
                 <div class="features">
                    ...
                    <h2 class="subtitle">order placed successfully!</h2>
                    <div class="feature-lists">
                       ...
                       <div class="single-feature wow fadeInUp">
                          ...
                          <div class="feature-details">
                             <h4>Your tracking number is</h4>
                             <p>{{$data['track']}}</p>
                             <h4>A copy of this has been sent to your Mail</h4>
                          </div>
                       </div>
                       ...
                       <div class="single-feature wow fadeInUp">
                           ...
                           <div class="feature-details">
                              <h3>Order will be delivered within 2-4 days</h3>
                              <p></p>
                           </div>
                        </div>
               ...
               <div class="row">
                  ...
                  <div class="offset-xl-1 col-xl-2 col-lg-2">
                     ...
                     <ul class="userful-links">
                        ...
                        <li><a href="quote.html">Service</a></li>
