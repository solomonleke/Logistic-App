...
<!-- Mirrored from kreativdev.com/transpix/transpix/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 19 Nov 2021 13:22:13 GMT -->
<head>
               ...
               <div class="row">
                  <div class="col-lg-6">
                     ...
                     <form action="" method="POST">
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-element"><input name="name" type="text" placeholder="Name"></div>
                           ...
                           <div class="col-md-6">
                              <div class="form-element"><input name="phone" type="number" placeholder="Phone"></div>
