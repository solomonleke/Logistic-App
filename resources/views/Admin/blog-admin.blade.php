...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="offset-lg-10 col-lg-2">
      <td><button  type="submit"  class="btn btn-info"><a id="btn" href="/add-blog">Add New Post</a></button></td>
    </div>
    <div class="card-body">
        <table id="example2" class="table table-bordered table-hover">
          ...
          <tr>
            ...
            <td>{{$blog->title}}</td> 
            <td>{{$blog->content}}</td> 
            <td><img class="img" src="{{"./blog_img/".$blog->blog_img}}" alt=""></td> 
            <td>{{$blog->category}}</td> 
            <td><button  type="submit"  class="btn btn-info"><a id="btn" href="/edit-blog?id={{$blog->id}}&action=edit">Edit</a></button></td>
            <td><button  type="submit" class="btn btn-danger"><a id="btn" href="/delete/{{$blog->id}}">Delete</a></button></td>
