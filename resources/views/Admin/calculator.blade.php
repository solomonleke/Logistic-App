  ...
  <div class="content-wrapper">
    ...
    <div class="card-body">
        ...
        <div class="offset-lg-10 col-lg-2">
            <button class="btn btn-info"><a id="btn" href="/edit-cal?id={{$rates['id']}}&action=edit">Edit Calculator</a></button>
        </div>
