...
<!-- Mirrored from kreativdev.com/transpix/transpix/blog-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 19 Nov 2021 13:21:26 GMT -->
<head>
            ...
            <div class="row">
               <div class="col-xl-7 col-lg-8">
                  <div class="blog-details">
                     <img class="blog-details-img-1" src="{{"./blog_img/".$data['blog_img']}}" alt="">
                     <small class="date">{{$data['created_at']}}  -  BY {{$data['author']}}</small>
                     <h2 class="blog-details-title">{{$data['title']}}</h2>
                     <div class="blog-details-body">
                        <p>{{$data['content']}}</p>
                        <div class="blog-details-quote">we supplements its own ultra-modern fleet and network with an extensive network of subcontractors and partners who work under the responsibility and control</div>
                        ...
                        <div class="popular-posts-lists">
                           ...
                           <div class="single-popular-post">
                              <div class="popular-post-img-wrapper">
                                 <img src="{{"./blog_img/".$value['blog_img']}}" alt="">
                              </div>
                              <div class="popular-post-txt">
                                 <h5 class="popular-post-title"><a href="/blog-readmore?id={{$value["id"]}}&action=readmore">{{$value['title']}}</a></h5>
...
<!-- Mirrored from kreativdev.com/transpix/transpix/blog-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 19 Nov 2021 13:21:43 GMT -->
</html>